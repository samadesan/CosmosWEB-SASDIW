            ...
            <section class="text-center mb-5">
                ...
                <div class="planeta-card p-4 mt-4" style="border-right: 4px solid var(--color-acento);">
                    ...
                    <p style="text-align: justify;">
                        Las estrellas son motores de fusión nuclear que transforman el hidrógeno en helio, liberando
                        energía en forma de luz y calor. Nacen en nebulosas de gas y polvo, y su destino final depende
                        exclusivamente de su <strong>masa inicial</strong>. Desde las longevas enanas rojas hasta las
                        efímeras supergigantes azules, cada estrella cuenta una historia sobre la evolución química del
                        universo.
                    </p>
                </div>
            </section>
