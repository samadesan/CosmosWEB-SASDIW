        ...
        <div class="row g-4 justify-content-center" style="margin-top: 20px">
            ...
            <section class="text-center mb-5">
                <div class="planeta-card p-4 mt-4" style="text-align: justify;">
                    ...
                    <p>
                        Un agujero negro es una región del espacio-tiempo donde la gravedad es tan fuerte que nada,
                        ni siquiera la luz, puede escapar de ella. La teoría de la relatividad general de Einstein
                        predice que una masa suficientemente compacta puede deformar el espacio-tiempo para formar uno.
                        El límite de no retorno se llama <strong>horizonte de sucesos</strong>.
                    </p>
                </div>
            </section>
